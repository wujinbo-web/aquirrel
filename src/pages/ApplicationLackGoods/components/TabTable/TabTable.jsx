...
import { addLackGoods, queryLackGoods, deleteAplication } from '@/api/apiUrl';
    ...
    this.columns = [
      ...
      },
      {
        ...
        render:(key, index, record)=>{
          return(
            <span>
              <Button shape="warning" size="small" onClick={this.deleteItem.bind(this, index, record)}>删除</Button>
            </span>
          )
        }
      }
