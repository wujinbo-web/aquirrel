...
export default class TabTable extends Component {
        ...
        render: (value, index, record) => {
          return (
            <span>
              ...
              {record.orderState==5 ? <DeleteBalloon
  ...
  ensureMeasure = (value, index, record) => {
    ...
    //修改订单状态
    axios
      .get(`${API_URL}/updateOrderState.do?orderId=${record.id}&orderState=6`)
      .then((response)=>{
  ...
  getOrderData = (pageIndex) => {
    ...
    //测量订单
    axios
      .get(`${API_URL}/findOrder.do?orderState=3,5&pageIndex=${pageIndex}`)
      .then((response)=>{
